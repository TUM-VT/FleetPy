...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        scs_path = os.path.join(os.path.dirname(__file__), "studies", "journal25_offer_ml", "scenarios")
        # ----------------------
        # a) determine fleet size
        log_level = "info"
        cc = os.path.join(scs_path, "constant_config.csv")
        sc = os.path.join(scs_path, "fleet_size_scenario_config.csv")
