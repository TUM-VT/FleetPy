...
# Create geodataframe
auto_demand_gdf_start = gpd.GeoDataFrame(data=auto_demand_df["trip_id"], geometry= gpd.points_from_xy(auto_demand_df["origin_x"], auto_demand_df["origin_y"]), crs=31468)
