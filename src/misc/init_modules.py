...
def load_simulation_environment(scenario_parameters, hook_manager=None, process_id=None) -> FleetSimulationBase:
    ...
    return sim_env_class(scenario_parameters, hook_manager, process_id)
