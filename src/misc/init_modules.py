...
def get_src_request_modules():
    ...
    rm_dict["StopBasedUserGroupRequest"] = ("src.demand.UserGroupTravelerModel", "StopBasedUserGroupRequest")
    # add development content
    if dev_content is not None:
...
def get_src_fleet_control_modules():
    ...
    op_dict["StopBasedRidePoolingBatchAssignmentFleetcontrol"] = ("src.fleetctrl.StopBasedRidePoolingBatchAssignmentFleetcontrol", "StopBasedRidePoolingBatchAssignmentFleetcontrol")
    # add development content
    if dev_content is not None:
