...
# main
# ----
class PTBrokerTPCS(BrokerBasic):
    def __init__(
        self, 
        n_amod_op: int, 
        ...
        # check whether only Phase 1 is used
        self.use_phase_1_only: bool = self.scenario_parameters.get(G_BROKER_TPCS_USE_DEFAULT, False)
