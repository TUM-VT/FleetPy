...
# First approach --------------------------------------------------------------------------
## Mean is fixed and variance is modified by a factor factor_sdlog
...
# Save df in the same directory as the current file
# TODO: Define path where this should be saved
# write.csv(df, file = "C:/Users/ge75mum/Documents/Research/Fleetpy/tum-vt-fleet-simulation/FleetPy/data/demand/stochastic_PUDO_duration/log_distribution_parameters_scenarios.csv", row.names = FALSE)

# Plot ------------------------------------------------------------------------
# Plot the log normal distribution with the new parameters
